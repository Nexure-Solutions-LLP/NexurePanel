    ...
    <div class="container nexure-container">
        <div style="display:flex; align-items:center;">
            <div>
                ...
                <h6 class="font-bold" style="font-size:25px; margin:0; padding:0; margin-top:4%; margin-bottom:3%;">You have successfully signed off we hope you have a Good <span id="lblGreetings"></span>.</h6>
