    ...
    <div class="container nexure-container">
        <div style="display:flex; align-items:center;">
            <div>
                ...
                <h6 class="secondary-font font-bold" style="font-weight:300; font-size:25px; margin:0; padding:0; margin-top:4%; margin-bottom:3%;"><?php echo $LANG_SERVERERROR_TITLE; ?></h6>
